...
if ( ! function_exists('b4st_enqueues') ) {
	function b4st_enqueues() {
		...
		wp_register_style('fontawesome5', 'https://use.fontawesome.com/releases/v5.11.2/css/all.css', false, '5.6.1', null);
		...
		wp_register_style('animate', get_template_directory_uri() . '/assets/css/animate.css', false, '3.7.2');
